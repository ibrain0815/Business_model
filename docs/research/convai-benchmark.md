...
| **본사** | 미국 (샌프란시스코) |
| **직원 수** | 약 43명 |
| **누적 투자** | $5M (약 72억원) (Seed Round) |
| **2024년 매출** | $6.5M (약 94억원) (추정) |
...
| 플랜 | 월 요금 | 주요 특징 |
|-----|--------|----------|
| **Free** | $0 (무료) | 100 크레딧/월, 학습용 |
| **Indie Dev** | $29 (약 4.2만원) | 1,000 크레딧, 상업적 사용 |
| **Professional** | $99 (약 14.3만원) | 5,000 크레딧, 우선 지원 |
| **Scale** | $499 (약 72만원) | 25,000 크레딧, 전용 서버 |
| **Business** | $1,199+ (약 173만원+) | 무제한, 엔터프라이즈 기능 |
...
| 비교 대상 | 월 비용 | 대화 수 기준 |
|---------|--------|------------|
| **Convai Professional** | $99 (약 14.3만원) | ~500 대화/월 |
| **Inworld AI Pro** | $299 (약 43만원) | ~1,000 대화/월 |
| **Character.AI Pro** | $9.99 (약 1.4만원) | 개인용 (비상업) |
| **자체 구축 (Claude API)** | $50-200 (약 7~29만원) | 사용량 비례 |
...
```
Convai 가격대: $29-1,199/월 (약 4.2~173만원) (B2B)
...
3. **시장 검증 역할**
   - AI 캐릭터 시장의 성장 가능성 확인 ($5M/72억원 투자, $6.5M/94억원 매출)
